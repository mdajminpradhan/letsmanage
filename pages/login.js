  ...
  return (
    <WithAuthentication>
      <div className="h-screen bg-silent bg-no-repeat bg-cover grid place-content-center">
        <form onSubmit={handleSubmit(loginAccount)} className="bg-[#D9D9D9] bg-opacity-5 border border-white border-opacity-10 rounded-xl w-72 sm:w-[550px] px-5 sm:px-10 py-10">
          ...
          <Link href="/createaccount" legacyBehavior>
            <a className="text-white text-center text-sm sm:text-base w-full hover:bg-white hover:bg-opacity-20 block mt-4 py-1.5 rounded-xl">Create a new account</a>
          </Link>
