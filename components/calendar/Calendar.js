...
import { ChevronDoubleLeftIcon, ChevronDoubleRightIcon, EllipsisVerticalIcon } from '@heroicons/react/20/solid';
        ...
        {({ open }) => (
          ...
          <>
            <Popover.Button className={'relative'}>
              Solutions
              <CalculatorIcon className={open ? 'rotate-180 transform' : ''} />
            </Popover.Button>
            <Transition
            ...
            <Popover.Panel>
              <div className="absolute z-50 pt-16 bg-black">
